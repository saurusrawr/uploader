...
body::before{content:"\00A9  Saurus gntg.id";color:white;opacity:.7;font-size:10px;position:fixed;bottom:25px;right:25px;z-index:150}
...
.stiker img{width:85px;height:85px;}
...
#Tombol{position:relative;opacity:0;margin-left:auto;margin-right:auto;display:flex;align-items:center;justify-content:center;list-style:none;transition:all 1s ease;}
